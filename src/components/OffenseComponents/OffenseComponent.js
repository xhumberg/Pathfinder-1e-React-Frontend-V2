  ...
  render() {
    if (this.props.windowWidth !== PageSize.MOBILE) {
      ...
      if (this.props.windowWidth === PageSize.TABLET) 
        width=725;
      return <Pane width={width} height={370} margin={0} background="green" borderRadius={15} display="flex" alignItems="center" justifyContent="center" flexDirection="column" border={true} padding={10}>
